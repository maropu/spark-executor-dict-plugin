...
class StringKeyDictTests(ReusedSQLTestCase):
    ...
    def conf(cls):
        return SparkConf() \
            ...
            .set("spark.files", "{}/string_key_dict.db".format(os.getenv("DICT_TESTDATA"))) \
            .set("spark.plugins.executorDict.port", "8000") \
            .set("spark.plugins.executorDict.keyType", "string")

    @classmethod
    def setUpClass(cls):
        super(StringKeyDictTests, cls).setUpClass()
    ...
    def test_retry_errors(self):
        ...
        self.assertRaises(RuntimeError, lambda: client.lookup_by_str('1'))
