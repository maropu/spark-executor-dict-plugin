...
def run_individual_python_test(target_dir, test_name, pyspark_python, params):
    env = dict(os.environ)
    env.update({
        'PYTHONPATH': params["DICT_MODULE_PATH"],
        'DICT_API_LIB': params["DICT_API_LIB"],
        'DICT_TESTDATA': params["DICT_TESTDATA"],
        'SPARK_TESTING': '1',
...
def main():
    ...
    params = {
        "DICT_API_LIB": opts.package,
        "DICT_MODULE_PATH": opts.module,
        "DICT_TESTDATA": opts.data
    }
